...
create database enterprise_v0;

create user euser;
alter user euser with encrypted password '123@123@123';

\connect enterprise_v0
...
grant all privileges on all tables in schema public to euser;
